...
xsv join stop_reference,route_reference focus_temp_opendata_linepoints.csv stop_ref:FR:STIF,line_ref:FR:STIF osm_routepoints_for_matching.csv |xsv select route_reference,stop_reference,route_short_name,stop_lat,stop_lon,stop_name,name,latitude,longitude,stop_id,route_id,line_id > focus_merged.csv
