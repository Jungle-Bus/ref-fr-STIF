...
xsv join --left route_id opendata_lignes.csv osm:ref:FR:STIF:ExternalCode_Line lignes.csv|xsv select 1-8,line_id |xsv sort -s line_id|xsv sort -s agency_name > opendata_lines_with_osm_id.csv
